 ...
 *
 * Disassembly of ssdt.aml, Sun Sep 20 15:33:24 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00005914 (22804)
 *     Revision         0x02
 *     Checksum         0x99
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.SW2S, IntObj)    // Warning: Unknown object
    ...
    External (_SB_.W715, UnknownObj)    // Warning: Unknown object
    ...
    External (CMSR, IntObj)    // Warning: Unknown object
    External (CMSW, MethodObj)    // Warning: Unknown method, guessing 2 arguments
    ...
    OperationRegion (SANV, SystemMemory, 0xAC811D98, 0x0104)
        ...
        Device (DD1F)
        {
            ...
            Method (_BCL, 0, NotSerialized)  // _BCL: Brightness Control Levels
            {
                ...
                ElseIf ((OSYS < 0x07DC))
                {
                    ...
                    PLD9 = DerefOf (GC1L [0x0B])
                    PLDA = DerefOf (GC1L [0x0C])
                    Return (GC1L)
                }
                Else
                {

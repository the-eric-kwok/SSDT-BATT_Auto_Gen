 ...
 *
 * Disassembly of DSDT.aml, Sat Oct 10 21:52:07 2020
 *
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x8CF68018, 0x0744)
    ...
    OperationRegion (OGNS, SystemMemory, 0x8CF68FD8, 0x00000010)

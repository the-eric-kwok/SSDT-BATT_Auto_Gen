 ...
 *
 * Disassembly of /Users/eric/Downloads/CLOVER-安装原始备份/ACPI/origin/DSDT.aml, Wed Nov 25 13:24:46 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010FD9 (69593)
 *     Revision         0x01 **** 32-bit table (V1), no 64-bit math support
 *     Checksum         0x37
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "TP-G5   "
 *     OEM Revision     0x00002760 (10080)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20061109 (537268489)
 */
DefinitionBlock ("", "DSDT", 1, "LENOVO", "TP-G5   ", 0x00002760)
{
    External (_PR_.CLVL, UnknownObj)    // Warning: Unknown object
        ...
        Device (PCI0)
        {
                ...
                Device (EC)
                {
                    ...
                    Method (CLPM, 0, NotSerialized)
                    {
                        ...
                        If (\VDSP)
                        {
                            ...
                            If (Local0)
                            {
                                \_SB.PCI0.PEG.VID.NPWC (0x01, 0x04)
                            }
                            Else
                            {
                                \_SB.PCI0.PEG.VID.NPWC (0x01, 0x00)
                            }
                        }
                    }

                    Method (CTDC, 0, NotSerialized)
                    {
                        Local0 = 0x00
                        If (\_SB.PCI0.LPC.EC.AC._PSR ())
                        {
                    ...
                    Device (HKEY)
                    {
                        ...
                        Method (PMSG, 1, NotSerialized)
                        {
                            ...
                            If (!\APIN)
                            {
                                If ((Local0 & 0x10))
                                {
                                    ...
                                    If (\VDSP)
                                    {
                                        \_SB.PCI0.PEG.VID.NPWC (0x02, 0x04)
                                    }
                                }
                                Else
                                {
                                    ...
                                    If (\VDSP)
                                    {
                                        \_SB.PCI0.PEG.VID.NPWC (0x02, 0x00)
                                    }
                                }
                        ...
                        {
                            \PRSM (0x01, Arg0)
                            If (((!\APMD && (Arg0 & 0x10)) || (\APMD && !(Arg0 & 0x10))))
                            {
                                If ((Arg0 & 0x10))
                                {
                                    \APMD = 0x01
            ...
            Device (PEG)
            {
                ...
                Device (VID)
                {
                    ...
                    OperationRegion (ATRP, SystemMemory, \ATRB, 0x00016800)
                    ...
                    Method (_ROM, 2, Serialized)  // _ROM: Read-Only Memory
                    {
                        If ((Arg0 >= 0xB400))
                        {
                            Return (GETB ((Arg0 - 0xB400), Arg1, IDX1))
                        }
                    ...
                    Name (NPWS, Buffer (0x04){})
                    Method (NPWC, 2, NotSerialized)
                    {
                        If ((Arg0 == 0x00))
                        {
                            Local1 = Arg1
            ...
            Device (XHCI)
            {
                ...
                Method (POSC, 3, Serialized)
                {
                    ...
                    If ((!(CDW1 & 0x01) && ((\XHCM == 0x02) || (\XHCM == 0x03))))
                    {
                        SXHC ()
                    }
        ...
        Scope (\_SB.PCI0.PEG.VID)
        {
            ...
            Method (NVOP, 4, NotSerialized)
            {
                ...
                If ((_T_0 == 0x00))
                {
                    ...
                    Local2 = (0x01 << Local2)
                    Local0 [Local1] = (DerefOf (Local0 [Local1]) | Local2)
                    Divide (0x06, 0x08, Local2, Local1)
                    Local2 = (0x01 << Local2)
                    Local0 [Local1] = (DerefOf (Local0 [Local1]) | Local2)
                    Return (Local0)
                }
                ...
                ElseIf ((_T_0 == 0x05))
                {
                    CreateField (Arg3, 0x00, 0x0C, DATT)
                    CreateField (Arg3, 0x0C, 0x0C, DACT)
                    CreateField (Arg3, 0x18, 0x01, DMSK)
                    CreateField (Arg3, 0x19, 0x05, NXCN)
                    CreateField (Arg3, 0x1F, 0x01, NXCM)
                    Local7 = 0x00
                    If ((ToInteger (DMSK) == 0x01))
                    {
                        Local0 = NILC ()
                        Local0 |= (ToInteger (DATT) << 0x01)
                        Local0 |= (ToInteger (DACT) << 0x11)
                        Local1 = SizeOf (TGLL)
                        Local2 = 0x00
                        Local3 = (Local0 >> 0x10)
                        While ((Local2 < Local1))
                        {
                            If ((DerefOf (TGLL [Local2]) == Local3))
                            {
                                Break
                            }
                        ...
                        While ((Local4 < Local1))
                        {
                            ...
                            Local5 = DerefOf (TGLL [Local2])
                            Local6 = (Local3 & Local5)
                            If ((Local5 == Local6))
                            {
                                If (((Local3 & 0x01) == (Local5 & 0x01)))
                                {
                                    Local7 = Local2
                                    Local7++
                                    Break
                ...
                ElseIf ((_T_0 == 0x06))
                {
                    ...
                    While ((Local2 < Local1))
                    {
                        Local3 = ToInteger (DerefOf (Local0 [Local2]))
                        If (((Local3 & 0x0F0F) == 0x0400))
                        {
                            Local4 = \_SB.PCI0.VID.LCD0._ADR ()
                        }
            ...
            Method (NILC, 0, NotSerialized)
            {
                ...
                While ((Local2 < 0x08))
                {
                    ...
                    If ((_T_0 == 0x00))
                    {
                        Local0 = (\_SB.PCI0.VID.CPDL & 0x0F0F)
                    }
                    ElseIf ((_T_0 == 0x01))
                    {
                        Local0 = (\_SB.PCI0.VID.CPL2 & 0x0F0F)
                    }
                    ElseIf ((_T_0 == 0x02))
                    {
                        Local0 = (\_SB.PCI0.VID.CPL3 & 0x0F0F)
                    }
                    ElseIf ((_T_0 == 0x03))
                    {
                        Local0 = (\_SB.PCI0.VID.CPL4 & 0x0F0F)
                    }
                    ElseIf ((_T_0 == 0x04))
                    {
                        Local0 = (\_SB.PCI0.VID.CPL5 & 0x0F0F)
                    }
                    ElseIf ((_T_0 == 0x05))
                    {
                        Local0 = (\_SB.PCI0.VID.CPL6 & 0x0F0F)
                    }
                    ElseIf ((_T_0 == 0x06))
                    {
                        Local0 = (\_SB.PCI0.VID.CPL7 & 0x0F0F)
                    }
                    ElseIf ((_T_0 == 0x07))
                    {
                        Local0 = (\_SB.PCI0.VID.CPL8 & 0x0F0F)
                    }
                ...
                While ((Local2 < 0x08))
                {
                    ...
                    If ((_T_1 == 0x00))
                    {
                        Local0 = (\_SB.PCI0.VID.CADL & 0x0F0F)
                    }
                    ElseIf ((_T_1 == 0x01))
                    {
                        Local0 = (\_SB.PCI0.VID.CAL2 & 0x0F0F)
                    }
                    ElseIf ((_T_1 == 0x02))
                    {
                        Local0 = (\_SB.PCI0.VID.CAL3 & 0x0F0F)
                    }
                    ElseIf ((_T_1 == 0x03))
                    {
                        Local0 = (\_SB.PCI0.VID.CAL4 & 0x0F0F)
                    }
                    ElseIf ((_T_1 == 0x04))
                    {
                        Local0 = (\_SB.PCI0.VID.CAL5 & 0x0F0F)
                    }
                    ElseIf ((_T_1 == 0x05))
                    {
                        Local0 = (\_SB.PCI0.VID.CAL6 & 0x0F0F)
                    }
                    ElseIf ((_T_1 == 0x06))
                    {
                        Local0 = (\_SB.PCI0.VID.CAL7 & 0x0F0F)
                    }
                    ElseIf ((_T_1 == 0x07))
                    {
                        Local0 = (\_SB.PCI0.VID.CAL8 & 0x0F0F)
                    }
    ...
    Method (\_WAK, 1, NotSerialized)  // _WAK: Wake
    {
        ...
        If (\VDSP)
        {
            \_SB.PCI0.PEG.VID.NPWC (0x00, 0x00)
        }
    ...
    Scope (\_SB.PCI0.LPC.EC)
    {
        Method (_Q40, 0, NotSerialized)  // _Qxx: EC Query
        {
            ...
            If (\VDSP)
            {
                If (\_SB.PCI0.LPC.EC.TSR0)
                {
                    \_SB.PCI0.PEG.VID.NPWC (0x03, 0x04)
                }
                Else
                {
                    \_SB.PCI0.PEG.VID.NPWC (0x03, 0x00)
                }
            }
        }
    }

 ...
 *
 * Disassembly of /Volumes/Data/eric/Downloads/要传的东西/ACPI/DSDT.aml, Sat Mar 27 16:17:21 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001648C (91276)
 ...
 */
DefinitionBlock ("", "DSDT", 1, "LENOVO", "TP-N17  ", 0x00001410)
{
    /*
    ...
    External (_SB_.PCI0.CTCL, IntObj)
    ...
    External (_SB_.PCI0.LPC_.EC__.CHRG, UnknownObj)
    External (_SB_.PCI0.LPC_.EC__.SSD0, UnknownObj)
    External (_SB_.PCI0.LPC_.EC__.WLN0, UnknownObj)
    External (_SB_.PCI0.LPC_.EC__.WWN0, UnknownObj)
    ...
    External (_SB_.PCI0.TPCH, UnknownObj)
    ...
    External (_SB_.PCI0.VID_.IUEH, MethodObj)    // Warning: Unknown method, guessing 1 arguments
    ...
    Scope (\_SB)
    {
        ...
        Device (MEM)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If (!CondRefOf (\_SB.PCI0.LPC.TPM))
                {
                    MEL2 = 0x01400000
                    MEL3 = 0x00
                }
                ElseIf ((\_SB.PCI0.LPC.TPM._STA != 0x0F))
                {
                    MEL2 = 0x01400000
                    MEL3 = 0x00
                }
        ...
        Scope (\)
        {
            ...
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0008 */  0x99, 0x11, 0x80, 0x02, 0x03, 0x00, 0x00, 0x00   // ........
            })
            ...
            Name (PLDF, Buffer (0x10)
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0008 */  0x28, 0x01, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00   // (.......
            })
            Name (PLD4, Buffer (0x14)
            {
                /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                /* 0008 */  0x28, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // (.......
                /* 0010 */  0xB0, 0x00, 0xAB, 0x00                           // ....
            })
        ...
        Device (PCI0)
        {
            ...
            Device (LPC)
            {
                ...
                Device (EC)
                {
                    ...
                    {
                        Acquire (BATM, 0xFFFF)
                        If ((\_SB.PCI0.LPC.EC.HIID != 0x60))
                        {
                            \_SB.PCI0.LPC.EC.HIID = 0x60
                            Sleep (0x1E)
                        }
                        ...
                        Switch (ToInteger (Arg0))
                        {
                            Case (0x02)
                            {
                                Local0 = \_SB.PCI0.LPC.EC.SIA2
                            }
                            Case (0x08)
                            {
                                Local0 = \_SB.PCI0.LPC.EC.SIA8
                            }
                            Case (0x09)
                            {
                                Local0 = \_SB.PCI0.LPC.EC.SIA9
                            }
                            Case (0x0A)
                            {
                                Local0 = \_SB.PCI0.LPC.EC.SIAA
                            }
                            Case (0x0B)
                            {
                                Local0 = \_SB.PCI0.LPC.EC.SIAB
                            }
                            Case (0x0C)
                            {
                                Local0 = \_SB.PCI0.LPC.EC.SIAC
                            }
                            Case (0x0D)
                            {
                                Local0 = \_SB.PCI0.LPC.EC.SIAD
                            }
                    ...
                    {
                        Local0 = \_SB.PCI0.LPC.EC.TSSR
                        While (Local0)
                        {
                            \_SB.PCI0.LPC.EC.TSSR = 0x00
                            If (Local0 &= 0x02){}
                            Local0 = \_SB.PCI0.LPC.EC.TSSR
                        }
                    }
                    ...
                    {
                        If ((\_SB.PCI0.LPC.EC.HKEY.DEIT == 0x00))
                        {
                            Return (Zero)
                        }

                        If ((\_SB.PCI0.LPC.EC.HKEY.DEWK == 0x01))
                        {
                            Notify (\_SB.LID, 0x80) // Status Change
                        }

                        \_SB.PCI0.LPC.EC.HKEY.DEST = One
                        \_SB.PCI0.LPC.EC.HKEY.MHKQ (0x5020)
                    }
                    ...
                    Method (_Q7D, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
                    {
                        ...
                        \_SB.PCI0.LPC.EC.HKEY.DEST = Zero
                        \_SB.PCI0.LPC.EC.HKEY.MHKQ (0x5020)
                    }
                    ...
                    Device (HKEY)
                    {
                        ...
                        {
                            Local0 = DEST /* \_SB_.PCI0.LPC_.EC__.HKEY.DEST */
                            ((DEIT << 0x01) + Local0)
                            ((DEWK << 0x02) + Local0)
                            Return (Local0)
                        }
                    ...
                    Scope (\_SB.PCI0.LPC.EC)
                    {
                        ...
                        {
                            Local0 = \_SB.PCI0.LPC.EC.VBKY
                            If ((Local0 == 0x01))
                            {
                                If ((\_SB.PWRB.PBST == 0x01))
                                {
                    ...
                    Scope (\_SB.PCI0.LPC.EC)
                    {
                        Name (SPDK, 0x00)
                        Name (WADS, 0x01)
                        Method (UPDK, 0, NotSerialized)
                        {
                            If (((DOCD == 0x01) || (HLBU == 0x01)))
                            {
                                DKMD = 0x01
                            }
                            Else
                        ...
                        Method (_Q45, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
                        {
                            If (((DOCD == 0x01) || (HLBU == 0x01)))
                            {
                                ...
                                \_SB.PCI0.LPC.EC.HKEY.MHKQ (0x4012)
                                DKMD = 0x01
                                USPD ()
                                If (!SPDK)
                                {
                                ...
                                If (((DPTF == 0x01) && (WADS == 0x00)))
                                {
                                    ...
                                    Notify (\_SB.PCI0.LPC.EC.WLN0, 0x91) // Device-Specific
                                    Notify (\_SB.PCI0.LPC.EC.WWN0, 0x91) // Device-Specific
                                    Notify (\_SB.PCI0.LPC.EC.SSD0, 0x91) // Device-Specific
                                    Notify (\_SB.PCI0.LPC.EC.CHRG, 0x91) // Device-Specific
                                }
                            }
                            Else
                            {
                                ...
                                \_SB.PCI0.LPC.EC.HKEY.MHKQ (0x4013)
                                DKMD = 0x00
                                Notify (^VGBI, 0xCB) // Hardware-Specific
                                Notify (^VGBI, 0xCC) // Hardware-Specific
                                If (((DPTF == 0x01) && (WADS == 0x00)))
                        ...
                        Method (USPD, 0, NotSerialized)
                        {
                            If (\H8DR)
                            {
                                SPDK = SPDF /* \_SB_.PCI0.LPC_.EC__.SPDF */
                            }
                            ElseIf ((\RBEC (0xFE) & 0x04))
                            {
                                SPDK = 0x01
                            }
                            Else
                    ...
                    Scope (\_SB.PCI0.LPC.EC.HKEY)
                    {
                        ...
                        {
                            Local0 = 0x00
                            If (((\_SB.PCI0.LPC.EC.DOCD == 0x01) || (\_SB.PCI0.LPC.EC.HLBU == 0x01)))
                            {
                                Local0 |= 0x01
                                If (DOCD)
                                {
                            ...
                            Local0 |= 0x00020000
                            If (\_SB.PCI0.LPC.EC.DOCD)
                            {
                                If (\_SB.PCI0.LPC.EC.UBKF)
                                {
                                    Local0 |= 0x03000000
                                }

                                If (\_SB.PCI0.LPC.EC.SPDF)
                                {
                                    Local0 |= 0x00
                                }
                            }

                            If (\_SB.PCI0.LPC.EC.HLBU)
                            {
                                Local0 |= 0x01000000
                            }
            ...
            Device (SMBU)
            {
                ...
                Device (NFC)
                {
                    Name (_HID, EisaId ("BCM2F21"))  // _HID: Hardware ID
                    Name (_CID, EisaId ("BCM2F21"))  // _CID: Compatible ID
                    Name (_UID, 0x00)  // _UID: Unique ID
                    Method (_STA, 0, NotSerialized)  // _STA: Status
                    {
            ...
            Device (XHCI)
            {
                ...
                {
                    If (((PCHG == 0x01) && (PCHS == 0x01)))
                    {
                        Return (LPTH) /* \_SB_.PCI0.XHCI.LPTH */
                    }

                    If (((PCHG == 0x01) && (PCHS == 0x02)))
                    {
                ...
                OperationRegion (XHCP, SystemMemory, (0xF8000000 + 0x000A0000), 0x0100)
                ...
                Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                {
                    ...
                    Local2 = ^MBA1 /* \_SB_.PCI0.XHCI.MBA1 */
                    ...
                    If (((PCHG == 0x01) || ((PCHV () == WPTL) && (PCHP == 0x41))))
                    {
                        ^SWAI = 0x00
                        ^SAIP = 0x00
                    }
                ...
                Device (URTH)
                {
                    ...
                    Device (HSP0)
                    {
                        ...
                        Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                        {
                            ...
                            CopyObject (\UPCF, UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP0._UPC.UPCP */
                            If (!(PR2 & 0x01))
                            {
                                UPCP [0x00] = 0x00
                            }
                    ...
                    Device (HSP2)
                    {
                        ...
                        Device (PTR0)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                ...
                                CopyObject (\UPC5, UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR0._UPC.UPCP */
                                If (!(PR2 & 0x04))
                                {
                                    UPCP [0x00] = 0x00
                                }

                                Return (UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR0._UPC.UPCP */
                            }
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLDP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR0._PLD.PLDP */
                            }
                        }
                        ...
                        Device (PTR1)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                ...
                                CopyObject (\UPC6, UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR1._UPC.UPCP */
                                If (!(PR2 & 0x04))
                                {
                                    UPCP [0x00] = 0x00
                                }

                                Return (UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR1._UPC.UPCP */
                            }
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLDP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR1._PLD.PLDP */
                            }
                        }
                        ...
                        Device (PTR2)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                ...
                                CopyObject (\UPC7, UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR2._UPC.UPCP */
                                If (!(PR2 & 0x04))
                                {
                                    UPCP [0x00] = 0x00
                                }

                                Return (UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR2._UPC.UPCP */
                            }
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLDP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR2._PLD.PLDP */
                            }
                        }
                        ...
                        Device (PTR3)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                ...
                                CopyObject (\UPC7, UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR3._UPC.UPCP */
                                If (!(PR2 & 0x04))
                                {
                                    UPCP [0x00] = 0x00
                                }

                                Return (UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR3._UPC.UPCP */
                            }
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLDP) /* \_SB_.PCI0.XHCI.URTH.HSP2.PTR3._PLD.PLDP */
                            }
                        }
                    }
                    ...
                    Device (HSP7)
                    {
                        ...
                        Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                        {
                            ...
                            CopyObject (\UPCF, UPCP) /* \_SB_.PCI0.XHCI.URTH.HSP7._UPC.UPCP */
                            If (!(PR2 & 0x80))
                            {
                                UPCP [0x00] = 0x00
                            }
                    ...
                    Device (SSP0)
                    {
                        ...
                        Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                        {
                            ...
                            CopyObject (\UPCF, UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP0._UPC.UPCP */
                    ...
                    Device (SSP2)
                    {
                        ...
                        Device (PTR0)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                ...
                                CopyObject (\UPC5, UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR0._UPC.UPCP */
                                If (!(PR2 & 0x04))
                                {
                                    UPCP [0x00] = 0x00
                                }

                                Return (UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR0._UPC.UPCP */
                            }
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLDP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR0._PLD.PLDP */
                            }
                        }
                        ...
                        Device (PTR1)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                ...
                                CopyObject (\UPC6, UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR1._UPC.UPCP */
                                If (!(PR2 & 0x04))
                                {
                                    UPCP [0x00] = 0x00
                                }

                                Return (UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR1._UPC.UPCP */
                            }
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLDP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR1._PLD.PLDP */
                            }
                        }
                        ...
                        Device (PTR2)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                ...
                                CopyObject (\UPC6, UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR2._UPC.UPCP */
                                If (!(PR2 & 0x04))
                                {
                                    UPCP [0x00] = 0x00
                                }

                                Return (UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR2._UPC.UPCP */
                            }
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLDP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR2._PLD.PLDP */
                            }
                        }
                        ...
                        Device (PTR3)
                        {
                            ...
                            Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                            {
                                ...
                                CopyObject (\UPC6, UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR3._UPC.UPCP */
                                If (!(PR2 & 0x04))
                                {
                                    UPCP [0x00] = 0x00
                                }

                                Return (UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR3._UPC.UPCP */
                            }
                            ...
                            Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                            {
                                ...
                                Return (PLDP) /* \_SB_.PCI0.XHCI.URTH.SSP2.PTR3._PLD.PLDP */
                            }
                        }
                    }
                    ...
                    Device (SSP3)
                    {
                        ...
                        Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                        {
                            ...
                            CopyObject (\UPCF, UPCP) /* \_SB_.PCI0.XHCI.URTH.SSP3._UPC.UPCP */
                            If ((!(PR2 & 0x04) || !(PR3 & 0x04)))
                            {
                                UPCP [0x00] = 0x00
                            }
            ...
            Device (ADSP)
            {
                ...
                Name (_UID, 0x01)  // _UID: Unique ID
                Name (_SUB, "17AA222B")  // _SUB: Subsystem ID
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (MBUF, 2, Serialized)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.MBUF._Y2A._BAS, ADDR)  // _BAS: Base Address
            CreateDWordField (RBUF, \_SB.PCI0.MBUF._Y2A._LEN, LENG)  // _LEN: Length
            ADDR = Arg0
            LENG = Arg1
        ...
        Method (LDMA, 2, Serialized)
        {
            ...
            {
                FixedDMA (0x0000, 0x0000, Width32bit, _Y2D)
                FixedDMA (0x0000, 0x0000, Width32bit, _Y2E)
            })
            CreateWordField (DBUF, \_SB.PCI0.LDMA._Y2D._DMA, D1DM)  // _DMA: Direct Memory Access
            CreateWordField (DBUF, \_SB.PCI0.LDMA._Y2D._TYP, D1TY)  // _TYP: Type
            CreateWordField (DBUF, \_SB.PCI0.LDMA._Y2E._DMA, D2DM)  // _DMA: Direct Memory Access
            CreateWordField (DBUF, \_SB.PCI0.LDMA._Y2E._TYP, D2TY)  // _TYP: Type
            D1DM = Arg0
            D2DM = (Arg0 + 0x01)
            D1TY = Arg1
            D2TY = (Arg1 + 0x01)
        ...
        Device (GPI0)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y2F._MIN, BMIN)  // _MIN: Minimum Base Address
            CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y2F._MAX, BMAX)  // _MAX: Maximum Base Address
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                BMIN = GPMN /* \GPMN */
                BMAX = GPMX /* \GPMX */
    ...
    Scope (\_SB.PCI0)
    {
        Device (SPI1)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                ConcatenateResTemplate (Local0, LDMA (0x10, 0x00), Local0)
                Return (Local0)
            }
    ...
    Scope (\_SB.PCI0.I2C0)
    {
        Device (TOUS)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBFI) /* \_SB_.PCI0.I2C0.TOUS._CRS.SBFI */
            }
        ...
        Device (TPFU)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBFI) /* \_SB_.PCI0.I2C0.TPFU._CRS.SBFI */
            }
        }
    }
    ...
    Scope (\_SB.PCI0.I2C0)
    {
        ...
        {
            Name (_ADR, 0x01)  // _ADR: Address
            Name (_HID, "WCOM5014")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, 0x01)  // _UID: Unique ID
            Name (_S0W, 0x04)  // _S0W: S0 Device Wake State
            Method (_STA, 0, NotSerialized)  // _STA: Status
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.PCI0.I2C0.TOUC._CRS.RBUF */
            }
    ...
    Scope (\_SB.PCI0.I2C1)
    {
        ...
        {
            Name (_ADR, 0x00)  // _ADR: Address
            Name (_HID, "WCOM0009")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, 0x00)  // _UID: Unique ID
            Name (_S0W, 0x04)  // _S0W: S0 Device Wake State
            Method (_STA, 0, NotSerialized)  // _STA: Status
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBFI) /* \_SB_.PCI0.I2C1.WACP._CRS.SBFI */
            }
    ...
    Scope (\_SB.PCI0.I2C1)
    {
        Device (ACD0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.PCI0.I2C1.ACD0._CRS.RBUF */
            }
    ...
    Scope (\_SB.PCI0.I2C1)
    {
        ...
        {
            Name (_ADR, Zero)  // _ADR: Address
            Name (_HID, "INV6500")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, 0x02)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (UBUF, ResourceTemplate ()
                {
                    UartSerialBusV2 (0x0001C200, DataBitsEight, StopBitsOne,
                        ...
                        0x0010, 0x0010, "\\_SB.PCI0.UA01",
                        0x00, ResourceConsumer, , Exclusive,
                        )
                })
                Return (UBUF) /* \_SB_.PCI0.UA01.NVTF._CRS.UBUF */
            }
    ...
    Scope (\_SB.PCI0.SPI0)
    {
        ...
        {
            Name (_ADR, Zero)  // _ADR: Address
            Name (_HID, "VFSI6101")  // _HID: Hardware ID
            Name (_DDN, "Validity Fingerprint Sensor VFS6101")  // _DDN: DOS Device Name
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (UBUF) /* \_SB_.PCI0.SPI0.FPNT._CRS.UBUF */
            }
    ...
    Scope (\_SB.PCI0.ADSP)
    {
        ...
        {
            DerefOf (SSPP [0x00]) [0x01] = Arg0
            Local0 = (MCLK * 0x000FA000)
            Local1 = (SSPM ^ One)
            DerefOf (SSPP [0x02]) [0x01] = Local0
            DerefOf (SSPP [0x04]) [0x01] = Local1
        }
        ...
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
            ABTH = ADBT /* \ADBT */
            FMSK = ADFM /* \ADFM */
            \_SB.PCI0.I2C1.ACD0._INI ()
            \_SB.PCI0.ADSP.MCLK = \_SB.PCI0.I2C1.ACD0.MCLK
            \_SB.PCI0.ADSP.SCLK = \_SB.PCI0.I2C1.ACD0.SCLK
            \_SB.PCI0.ADSP.SSPM = \_SB.PCI0.I2C1.ACD0.SSPM
            Local0 = \_SB.PCI0.I2C1.ACD0._HID ()
            SSPI (Local0)
        }
    ...
    Scope (\_SB.PCI0.LPC)
    {
        OperationRegion (LPCA, PCI_Config, 0x00, 0x0100)
        Field (LPCA, AnyAcc, NoLock, Preserve)
        {
            Offset (0x02), 
            CDID,   16, 
            Offset (0x40), 
    ...
    Method (\_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If (Local0)
        {
            ...
            If ((Arg0 == 0x03))
            {
                ...
                Local1 = \IFRS (0x00, 0x00)
                \FFCL = 0x00
                If ((Local1 & 0x20))
                {
                    If (((Local1 & 0x00FFFF00) != 0x00FFFF00))
                    {
                        If (((\_SB.PCI0.LPC.EC.HB0A && ((\_SB.PCI0.LPC.EC.HB0S & 0x07) > 0x01)) || (\_SB.PCI0.LPC.EC.HB1A && 
                            ((\_SB.PCI0.LPC.EC.HB1S & 0x07) > 0x01))))
                        {
                            \FFCL = 0x00
                        }
                        Else
    ...
    Method (\_WAK, 1, NotSerialized)  // _WAK: Wake
    {
        ...
        \RRBF = Zero
        \_SB.PCI0.LPC.EC.WADS = 0x01
        \_SB.PCI0.LPC.EC.RSDE = 0x01
        Return (WAKI) /* \WAKI */
    }
        ...
        Method (DYTC, 1, Serialized)
        {
            ...
            If ((\WNTF && \TATC))
            {
                ...
                Switch (ToInteger (Local1))
                {
                    Case (0x00)
                    {
                        Local2 = (\DTCC & (0x01 | 0x02))
                        If (!(Local2 & 0x01))
                        {
                            Return (0x00)
                        }

                        Local3 = \_SB.PCI0.CTNL /* External reference */
                        If ((Local3 == 0x00))
                        {
                            Return (0x00)
                        }

                        Local3 = \_SB.PCI0.CTCL /* External reference */
                        Local3 = (Local3 & 0x03)
    ...
    Method (PNOT, 0, Serialized)
    {
        ...
        Notify (\_SB.PCI0.LPC.EC.BAT0, 0x81) // Information Change
                ...
                If ((Arg0 == ToUUID ("c4eb40a0-6cd2-11e2-bcfd-0800200c9a66") /* Unknown UUID */))
                {
                    ...
                    If ((Arg2 == One))
                    {
                        If (((PEPC & 0x03) == 0x01))
                        {
                            ...
                            If (\_SB.PCI0.EXP1.PXSX.PAHC ())
                            {
                                DerefOf (DEVY [0x1A]) [0x01] = 0x01
                            }

                            If (\_SB.PCI0.EXP2.PXSX.PAHC ())
                            {
                                DerefOf (DEVY [0x1B]) [0x01] = 0x01
                            }

                            If (\_SB.PCI0.EXP3.PXSX.PAHC ())
                            {
                        ...
                        If (((PEPC & 0x03) == 0x02))
                        {
                            ...
                            If ((\_SB.PCI0.EXP1.PXSX.PAHC () || \_SB.PCI0.EXP1.PXSX.PNVM ()))
                            {
                                DerefOf (DEVY [0x12]) [0x01] = 0x01
                            }

                            If ((\_SB.PCI0.EXP2.PXSX.PAHC () || \_SB.PCI0.EXP2.PXSX.PNVM ()))
                            {
                                DerefOf (DEVY [0x13]) [0x01] = 0x01
                            }

                            If ((\_SB.PCI0.EXP3.PXSX.PAHC () || \_SB.PCI0.EXP3.PXSX.PNVM ()))
                            {
                                DerefOf (DEVY [0x14]) [0x01] = 0x01
                            }
                        }
    ...
    Scope (\_SB.PCI0.LPC.EC)
    {
        ...
        Device (VGBI)
        {
            ...
            Method (VGBS, 0, Serialized)
            {
                ...
                Return (VBDS) /* \_SB_.PCI0.LPC_.EC__.VGBI.VBDS */
            }
    ...
    Scope (\_SB)
    {
        Device (PWRB)
        {
            ...
            Method (PBUP, 0, NotSerialized)
            {
                If (UPPS)
                {
                    Notify (\_SB.PWRB, 0xC0) // Hardware-Specific
                }
            }

 ...
 *
 * Disassembly of /Users/eric/Downloads/EFI_magicbook触控板/CLOVER/ACPI/acpi/dsdt.aml, Thu Oct 22 11:18:44 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000169B5 (92597)
 *     Revision         0x02
 *     Checksum         0x33
 *     OEM ID           "HUAWEI"
...
DefinitionBlock ("", "DSDT", 2, "HUAWEI", "KBL-ULT ", 0x00000000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.RTCP, UnknownObj)    // (from opcode)
    ...
    Method (GTMP, 1, NotSerialized)
    {
        ...
        If ((TEPE == Zero))
        {
            Local1 = \_SB.PCI0.LPCB.EC0.CTMP
        }
        ElseIf ((TEPE == One))
        {
            Local1 = \_SB.PCI0.LPCB.EC0.VGAT
        }
        ElseIf ((TEPE == 0x05))
        {
            Local1 = \_SB.PCI0.LPCB.EC0.VGET
        }
        ElseIf ((TEPE == 0x06))
        {
            Local1 = \_SB.PCI0.LPCB.EC0.VGET
        ...
        ElseIf ((TEPE == 0x07))
        {
            Local1 = \_SB.PCI0.LPCB.EC0.TNTC
        }
        ElseIf ((TEPE == 0x08))
        {
            Local1 = \_SB.PCI0.LPCB.EC0.CNTC
        }
        ElseIf ((TEPE == 0x0B))
        {
            Local1 = \_SB.PCI0.LPCB.EC0.DDRT
        }
        ElseIf ((TEPE == 0x0E))
        {
            Local1 = \_SB.PCI0.LPCB.EC0.BTTL
        }
        Else
        {
            Local1 = 0xFF
    ...
    Method (STMT, 1, NotSerialized)
    {
        ...
        If ((Local1 == Zero))
        {
            If ((SSRN == Zero))
            {
                \_SB.PCI0.LPCB.EC0.UCPU = TUPL
                \_SB.PCI0.LPCB.EC0.DCPU = TDNL
                \_SB.PCI0.LPCB.EC0.CPUF = Zero
                \_SB.PCI0.LPCB.EC0.CPDF = Zero
                \_SB.PCI0.LPCB.EC0.TFUC = Zero
                \_SB.PCI0.LPCB.EC0.TFDC = Zero
            }
            ElseIf ((SSRN == 0x0E))
            {
                \_SB.PCI0.LPCB.EC0.UBAT = TUPL
                \_SB.PCI0.LPCB.EC0.DBAT = TDNL
                \_SB.PCI0.LPCB.EC0.BAUF = Zero
                \_SB.PCI0.LPCB.EC0.BADF = Zero
                \_SB.PCI0.LPCB.EC0.TFUB = Zero
                \_SB.PCI0.LPCB.EC0.TFDB = Zero
            }
            ElseIf ((SSRN == 0x05))
            {
                \_SB.PCI0.LPCB.EC0.USYS = TUPL
                \_SB.PCI0.LPCB.EC0.DSYS = TDNL
                \_SB.PCI0.LPCB.EC0.SYUF = Zero
                \_SB.PCI0.LPCB.EC0.SYDF = Zero
                \_SB.PCI0.LPCB.EC0.TFUL = Zero
                \_SB.PCI0.LPCB.EC0.TFDL = Zero
            }
            ElseIf ((SSRN == 0x0B))
            {
                \_SB.PCI0.LPCB.EC0.UDDR = TUPL
                \_SB.PCI0.LPCB.EC0.DDDR = TDNL
                \_SB.PCI0.LPCB.EC0.DRUF = Zero
                \_SB.PCI0.LPCB.EC0.DRDF = Zero
                \_SB.PCI0.LPCB.EC0.TFUD = Zero
                \_SB.PCI0.LPCB.EC0.TFDD = Zero
            }
            ElseIf ((SSRN == 0x06))
            {
                \_SB.PCI0.LPCB.EC0.UGPE = TUPL
                \_SB.PCI0.LPCB.EC0.DGPE = TDNL
                \_SB.PCI0.LPCB.EC0.GPUF = Zero
                \_SB.PCI0.LPCB.EC0.GPDF = Zero
                \_SB.PCI0.LPCB.EC0.TFUG = Zero
                \_SB.PCI0.LPCB.EC0.TFDG = Zero
            }
            ElseIf ((SSRN == One))
            {
                \_SB.PCI0.LPCB.EC0.UPCH = TUPL
                \_SB.PCI0.LPCB.EC0.DPCH = TDNL
                \_SB.PCI0.LPCB.EC0.PHUF = Zero
                \_SB.PCI0.LPCB.EC0.PHDF = Zero
                \_SB.PCI0.LPCB.EC0.TFUR = Zero
                \_SB.PCI0.LPCB.EC0.TFDR = Zero
            }
            ElseIf ((SSRN == 0x07))
            {
                \_SB.PCI0.LPCB.EC0.UTPC = TUPL
                \_SB.PCI0.LPCB.EC0.DTPC = TDNL
                \_SB.PCI0.LPCB.EC0.TPUF = Zero
                \_SB.PCI0.LPCB.EC0.TPDF = Zero
                \_SB.PCI0.LPCB.EC0.TFUT = Zero
                \_SB.PCI0.LPCB.EC0.TFDT = Zero
            }
            ElseIf ((SSRN == 0x08))
            {
                \_SB.PCI0.LPCB.EC0.UCHG = TUPL
                \_SB.PCI0.LPCB.EC0.DCHG = TDNL
                \_SB.PCI0.LPCB.EC0.CGUF = Zero
                \_SB.PCI0.LPCB.EC0.CGDF = Zero
                \_SB.PCI0.LPCB.EC0.TFUH = Zero
                \_SB.PCI0.LPCB.EC0.TFDH = Zero
            }
            ...
            If ((ODVN <= 0x05))
            {
                Switch (ToInteger (ODVN))
                {
                    ...
                    Case (Zero)
                    {
                        ...
                        If ((ACIR == 0x02))
                        {
                            \_SB.PCI0.LPCB.EC0.SPMD = One
                        }
                        Else
                        {
                            \_SB.PCI0.LPCB.EC0.SPMD = Zero
                        }
    ...
    Method (GFRS, 1, NotSerialized)
    {
        ...
        STAT = Zero
        RELT = 0x02
        If ((\_SB.PCI0.LPCB.EC0.FNIS == Zero))
        {
            RELT = One
        }
    ...
    Method (SBTT, 1, NotSerialized)
    {
        ...
        CreateByteField (BUFF, Zero, STAT)
        STAT = Zero
        \_SB.PCI0.LPCB.EC0.BCCL = BCLB
        \_SB.PCI0.LPCB.EC0.BCCH = BCHB
        Return (BUFF)
    }
    ...
    Method (GBTT, 1, NotSerialized)
    {
        ...
        STAT = Zero
        GLCP = \_SB.PCI0.LPCB.EC0.BCCL
        GHCP = \_SB.PCI0.LPCB.EC0.BCCH
        Return (BUFF)
    }
    ...
    Method (GFNS, 1, Serialized)
    {
        ...
        Switch (ToInteger (FANN))
        {
            Case (Zero)
            {
                FANH = \_SB.PCI0.LPCB.EC0.FRHI
                FANL = \_SB.PCI0.LPCB.EC0.FRLO
            }
            Case (One)
            {
            }
    ...
    Method (SPDT, 1, NotSerialized)
    {
        Name (BUFF, Buffer (0x0100){})
        CreateByteField (BUFF, Zero, STAT)
        CreateByteField (Arg0, 0x02, SPBT)
        STAT = Zero
        If ((SPBT <= 0x28))
        {
            \_SB.PCI0.LPCB.EC0.EPBT = SPBT
        }
        Else
        {
            STAT = One
    ...
    Method (RPPT, 1, NotSerialized)
    {
        ...
        Local0 = Arg0
        CreateByteField (BUFF, Zero, STAT)
        CreateByteField (BUFF, One, RST1)
        CreateByteField (BUFF, 0x02, RST2)
        STAT = Zero
        RST1 = Zero
        RST2 = Zero
        RST1 = \_SB.PCI0.LPCB.EC0.EPBP
        Return (BUFF)
    }
    ...
    Method (SMLS, 1, Serialized)
    {
        ...
        Name (MILS, Zero)
        CreateByteField (BUFF, Zero, STAT)
        CreateByteField (Arg0, 0x02, SMCL)
        STAT = Zero
        Switch (ToInteger (SMCL))
        {
            Case (Zero)
            {
                MILS = Zero
                \_SB.PCI0.LPCB.EC0.MIMT = MILS
            }
            Case (One)
            {
                MILS = One
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x7FF6A018, 0x0766)
    ...
    OperationRegion (OGNS, SystemMemory, 0x7FF6AFD8, 0x0000000C)
    ...
    Scope (_SB.PCI0)
    {
        Device (XHC)
        {
            ...
            Method (URST, 1, Serialized)
            {
                ...
                Local0 |= XADL
                Local0 &= 0xFFFFFFFFFFFFFFF0
                Local1 = ((Local0 + 0x0480) + (Arg0 * 0x10))
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (TPL1)
        {
            Name (_HID, "WCOM48BF")  // _HID: Hardware ID
            Name (_CID, "PNP0C50")  // _CID: Compatible ID
            Name (_S0W, 0x03)  // _S0W: S0 Device Wake State
            Name (INTZ, 0x02040007)
            Name (SBFB, ResourceTemplate ()
            {
    ...
    Scope (_SB.PCI0.SPI1)
    {
        ...
        {
            Name (_ADR, Zero)  // _ADR: Address
            Name (_HID, "GXFP5197")  // _HID: Hardware ID
            Name (_CID, "GXFP5197")  // _CID: Compatible ID
            Name (_UID, One)  // _UID: Unique ID
            Name (FPPE, 0x02030010)
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                SHPO (GFPI, One)
                SHPO (GFPS, One)
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateWordField (BBUF, 0x63, SPIN)
                CreateWordField (BBUF, 0x3B, GPIN)
                CreateWordField (BBUF, 0x8B, PPIN)
                SPIN = GNUM (GFPS)
                GPIN = GNUM (GFPI)
                PPIN = GNUM (FPPE)
                SPEX = 0x00989680
        ...
        Device (BTH0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Name (SBFI, ResourceTemplate ()
                {
                    ...
                    Interrupt (ResourceConsumer, Edge, ActiveLow, ExclusiveAndWake, ,, _Y21)
                    {
                        0x00000000,
                    }
                })
                CreateDWordField (SBFI, \_SB.PCI0.UA00.BTH0._CRS._Y21._INT, INT4)  // _INT: Interrupts
        ...
        Scope (\_SB)
        {
            ...
            Device (BAT1)
            {
                ...
                Method (UPBX, 0, NotSerialized)
                {
                    ...
                    Else
                    {
                        PBIX [0x03] = ^^PCI0.LPCB.EC0.BTFC
                    }

                    PBIX [0x05] = ^^PCI0.LPCB.EC0.BTDV
                    PBIX [0x08] = ^^PCI0.LPCB.EC0.BTCC
                    Local0 = ^^PCI0.LPCB.EC0.BNAM
                ...
                Method (UPBI, 0, NotSerialized)
                {
                    ...
                    PBIF [One] = ^^PCI0.LPCB.EC0.BTAP
                    PBIF [0x02] = ^^PCI0.LPCB.EC0.BTFC
                    PBIF [0x04] = ^^PCI0.LPCB.EC0.BTDV
                    Local0 = ^^PCI0.LPCB.EC0.BNAM
                    PBFE (Local0, ^^PCI0.LPCB.EC0.BNBC, Zero)
                    PBIF [0x09] = Local0
                ...
                Method (UPBS, 0, NotSerialized)
                {
                    ...
                    PBST [One] = Local1
                    PBST [0x02] = ^^PCI0.LPCB.EC0.BT1C
                    PBST [0x03] = ^^PCI0.LPCB.EC0.BT1V
                    Return (Zero)
                }
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If ((Arg0 == 0x03))
        {
            ...
            If (((\_SB.PCI0.LPCB.EC0.LSTE == One) || (\_SB.PCI0.LPCB.EC0.D3BL == One)))
            {
        ...
        {
            H2OP (0x55)
            \_SB.PCI0.LPCB.EC0.S5FG = One
            WRCM (0x84, \_SB.PCI0.LPCB.EC0.KCMS)
            \_SB.PCI0.LPCB.EC0.RTCP = One
        }
    ...
    Scope (_SB)
    {
        ...
        Device (EPC)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateQWordField (RBUF, \_SB.EPC._Y23._MIN, EMIN)  // _MIN: Minimum Base Address
                CreateQWordField (RBUF, \_SB.EPC._Y23._MAX, EMAX)  // _MAX: Maximum Base Address
                CreateQWordField (RBUF, \_SB.EPC._Y23._LEN, ELEN)  // _LEN: Length
                EMIN = \_PR.EMNA
                ELEN = \_PR.ELNG
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                XSZ0 = GPCL ()
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y28._BAS, SXRA)  // _BAS: Base Address
                SXRA = SXRB
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y28._LEN, SXRL)  // _LEN: Length
                SXRL = SXRS
                If (!HPTE)
                {
    ...
    OperationRegion (MDBG, SystemMemory, 0x7FF57018, 0x00001004)

 ...
 *
 * Disassembly of /Volumes/Data/eric/Downloads/EFI HP EliteBook Folio 9470m/DSDT.aml, Sat Dec  5 11:36:16 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0002341B (144411)
 *     Revision         0x02
 *     Checksum         0xAB
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "18DF    "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "18DF    ", 0x00000001)
{
    /*
    ...
    OperationRegion (AF10, SystemMemory, 0xB9F7D018, 0x0D5C)
    ...
    Scope (\_SB)
    {
        ...
        Name (BSOL, Package (0x02)
        {
            ...
            {
                "Legacy Boot Order", 
                " Notebook Hard Drive, Notebook mSATA Drive, USB Floppy, USB CD-ROM, USB Hard Drive, Notebook Ethernet, SD Card, , , , , , , , , ,", 
            ...
            {
                "UEFI Boot Order", 
                " OS Boot Manager, Notebook mSATA Drive, USB Hard Drive, Notebook IPV4 Ethernet, Notebook IPV6 Ethernet, SD Card Boot, Generic USB Device, HP Hypervisor, Customized Boot, , , , , , , ,", 
                "\\System Configuration\\Boot Options", 
                0x00, 
                0x01, 
                0x00, 
        ...
        Name (BISE, Package (0xFF)
        {
            ...
            Package (0x10)
            {
                ...
                0x02D9, 
                0x03, 
                "SELECT * FROM HP_BIOSEnumeration WHERE Name=\'Intel(R) Rapid Start Technology\' AND CurrentValue=\'Enable\'", 
                " ", 
                " ", 
                0x00, 
                "Enable", 
            ...
            Package (0x16)
            {
                ...
                0x02DA, 
                0x03, 
                "SELECT * FROM HP_BIOSEnumeration WHERE Name=\'Entry on S3 RTC wake\' AND CurrentValue=\'Enable\'", 
                " ", 
                " ", 
                0x00, 
                "60 min", 
            ...
            Package (0x11)
            {
                "Notebook mSATA Drive Security Level", 
                "", 
                "\\System Configuration\\Security Level", 
                0x00, 
                0x01, 
            ...
            Package (0x11)
            {
                "mSATA Drive boot Security Level", 
                "", 
                "\\System Configuration\\Security Level", 
                0x00, 
                0x01, 
            ...
            Package (0x11)
            {
                "Intel(R) Rapid Start Technology Security Level", 
                "", 
                "\\System Configuration\\Security Level", 
                0x00, 
                0x01, 
        ...
        Name (BSPV, Package (0x05)
        {
            ...
            Package (0x12)
            {
                "mSATA drive drivelock master password", 
                " ", 
                "\\Security", 
                0x00, 
                0x01, 
            ...
            Package (0x12)
            {
                "mSATA drive drivelock user password", 
                " ", 
                "\\Security", 
                0x00, 
                0x01, 
        ...
        Device (WMID)
        {
            ...
            {
                Local3 = 0xFF
                If ((\SRCM (TEMP, "Notebook mSATA Drive", 0x14) || \SRCM (TEMP, " Notebook mSATA Drive", SizeOf (STG0))))
                {
                    Local3 = 0x01
                }
                ...
                If ((\SRCM (TEMP, "Notebook mSATA Drive", 0x14) || \SRCM (TEMP, " Notebook mSATA Drive", 0x15)))
                {
                    Local3 = 0x01
                }
            ...
            Name (_WDG, Buffer (0x0118)
            {
                ...
                /* 0070 */  0x09, 0xE7, 0x51, 0x33, 0x42, 0x43, 0xFF, 0x00,  // ..Q3BC..
                /* 0078 */  0xE3, 0x08, 0x8D, 0x98, 0xF4, 0x68, 0x35, 0x4C,  // .....h5L
                /* 0080 */  0xAF, 0x3E, 0x6A, 0x1B, 0x81, 0x06, 0xF8, 0x3C,  // .>j....<
                /* 0088 */  0x42, 0x44, 0x2F, 0x00, 0x46, 0x97, 0xEA, 0x14,  // BD/.F...

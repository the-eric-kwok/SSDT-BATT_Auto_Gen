 ...
 *
 * Disassembly of /Volumes/Data/eric/Downloads/efi/SysReport/ACPI/DSDT的副本.aml, Sun Mar 14 22:56:55 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001A40E (107534)
 *     Revision         0x02
 *     Checksum         0xFA
 *     OEM ID           "ACRSYS"
...
DefinitionBlock ("", "DSDT", 2, "ACRSYS", "ACRPRDCT", 0x00000000)
{
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x8AE70018, 0x06C4)
    ...
    OperationRegion (OGNS, SystemMemory, 0x8AE70FD8, 0x0C)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (SAT0)
        {
            ...
            Device (NVM1)
            {
                ...
                {
                    Return (ISD3) /* \_SB_.PCI0.SAT0.NVM1.ISD3 */
                }
            ...
            Device (NVM2)
            {
                ...
                Method (_PSC, 0, NotSerialized)  // _PSC: Power State Current
                {
                    Return (ISD3) /* \_SB_.PCI0.SAT0.NVM2.ISD3 */
                }
            ...
            Device (NVM3)
            {
                ...
                Method (_PSC, 0, NotSerialized)  // _PSC: Power State Current
                {
                    Return (ISD3) /* \_SB_.PCI0.SAT0.NVM3.ISD3 */
                }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC0)
        {
            ...
            {
                \RMDT.P1 ("[RMDT]EC _Q01 enter")
                HKEV (One, One)
                \RMDT.P1 ("[RMDT]EC _Q01 exit")
            }

            Method (_Q02, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q02 enter")
                HKEV (0x02, One)
                \RMDT.P1 ("[RMDT]EC _Q02 exit")
            }

            Method (_Q04, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q04 enter")
                HKEV (One, 0x83)
                \RMDT.P1 ("[RMDT]EC _Q04 exit")
            }

            Method (_Q05, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q05 enter")
                HKEV (One, 0x82)
                TPDS = TOHP /* \_SB_.PCI0.LPCB.EC0_.TOHP */
                \RMDT.P1 ("[RMDT]EC _Q05 exit")
            }

            Method (_Q06, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q06 enter")
                HKEV (One, 0x82)
                TPDS = TOHP /* \_SB_.PCI0.LPCB.EC0_.TOHP */
                \RMDT.P1 ("[RMDT]EC _Q06 exit")
            }

            Method (_Q0A, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q0A enter")
                HKEV (One, 0x22)
                \RMDT.P1 ("[RMDT]EC _Q0A exit")
            }

            Method (_Q0B, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q0B enter")
                HKEV (One, 0x24)
                \RMDT.P1 ("[RMDT]EC _Q0B exit")
            }

            Method (_Q0C, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q0C enter")
                HKEV (One, 0x23)
                \RMDT.P1 ("[RMDT]EC _Q0C exit")
            }

            Method (_Q0E, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q0E enter")
                If ((LMAT == One))
                {
                    HKEV (One, 0x64)
                }
                ...
                \RMDT.P1 ("[RMDT]EC _Q0E exit")
            }

            Method (_Q0F, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q0F enter")
                HKEV (0x02, 0x64)
                \RMDT.P1 ("[RMDT]EC _Q0F exit")
            }

            Method (_Q12, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q12 enter")
                HKEV (One, 0x21)
                \RMDT.P1 ("[RMDT]EC _Q12 exit")
            }
            ...
            {
                \RMDT.P1 ("[RMDT]EC _Q29 enter")
                \RMDT.P1 ("[RMDT]EC _Q29 exit")
            }

            Method (_Q57, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q57 enter")
                HKEV (One, 0x84)
                \RMDT.P1 ("[RMDT]EC _Q57 exit")
            }

            Method (_Q58, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q58 enter")
                HKEV (One, 0x84)
                \RMDT.P1 ("[RMDT]EC _Q58 exit")
            }

            Method (_Q5B, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q5B enter")
                HKEV (One, 0x24)
                \RMDT.P1 ("[RMDT]EC _Q5B exit")
            }

            Method (_Q62, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q62 enter")
                HKEV (One, 0x25)
                \RMDT.P1 ("[RMDT]EC _Q62 exit")
            }

            Method (_Q63, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                \RMDT.P1 ("[RMDT]EC _Q63 enter")
                If ((LMAT == One))
                {
                    If ((OSYS >= 0x07DC)){}
                    ElseIf ((RFST == Zero))
    ...
    OperationRegion (MDBG, SystemMemory, 0x8AE5D018, 0x1004)
